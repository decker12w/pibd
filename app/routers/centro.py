...
@router.post("", response_model=Centro, status_code=201)
...
@router.get("/{id_centro}", response_model=Centro)
...
@router.put("/{id_centro}", response_model=Centro)
...
@router.delete("/{id_centro}", status_code=204)
